# PlugMeNow — Google Play Store Listing (English)

## Title (≤30 characters)
PlugMeNow - EV Charging GR

## Short Description (≤80 characters)
Find EV charging stations across Greece — all networks in one app!
...
• Power level (slow, normal, fast, ultra-fast)
• Network
• Free stations only
• 24h operation only
• Compatible with your vehicle only

🗺️ MAP & NAVIGATION
• Map with clustering for easy browsing
• Color coding by power level
• Find your location
• Search by address or area
• One tap to navigate via Google Maps

📱 COMPLETELY FREE
No subscriptions, no ads, no tracking. The app respects your privacy — no personal data is collected.
